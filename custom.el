(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (vue-mode web-mode bundler yaml-mode rspec-mode rvm projectile-rails robe diminish pipenv elpy counsel-projectile magit evil-magit magic flycheck-popup-tip flycheck company projectile doom-themes window-numbering which-key counsel general evil use-package)))
 '(vue-dedicated-modes nil)
 '(vue-modes
   (quote
